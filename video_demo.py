...
if __name__ == '__main__':
    video_stream = {'camera_1': [], 'camera_2': [[],'/c3d/C3D-Action-Recognition/video/aaa.avi','results/aaa.avi' ]}
    video_stream['camera_1'].append([])
    video_stream['camera_1'].append('/c3d/C3D-Action-Recognition/video/bbb.avi')
